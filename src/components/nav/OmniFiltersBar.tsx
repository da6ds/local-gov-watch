...
export function OmniFiltersBar({
  ...
  return (
    <div className="sticky top-12 z-30 w-full border-b bg-muted/30 backdrop-blur supports-[backdrop-filter]:bg-muted/20">
      <div className="container flex h-9 items-center gap-1.5 md:gap-2 overflow-x-auto scrollbar-hide">
